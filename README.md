...
##### 
一个更方便、快捷的自动化OPPO/一加/真我系列骁龙8Elite Gen5(SM8850)机型的通用6.12内核编译脚本。
##### 
这个项目的初衷是解决以下问题：
...
## 已实现：
- [x] 骁龙 SM8850 通用OKI内核（基于一加Ace 6T源码的 6.12.38 ，其他同内核版本非SM8850机型可自行测试，部分机型可完全兼容）
...
- cctv18的欧加真米系列内核构建脚本：[oppo_oplus_realme_sm8850](https://github.com/cctv18/oppo_oplus_realme_sm8850)
